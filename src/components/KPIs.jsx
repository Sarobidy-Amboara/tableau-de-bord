...
export default function KPIs({dataset=[], onOpenClick, onClosedClick, onInSlaClick, onOutSlaClick}){
  ...
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
      ...
      <button type="button" onClick={onOpenClick} className="bg-white p-4 rounded shadow flex items-center gap-3 w-full text-left hover:ring-2 ring-slate-200">
      ...
      <button type="button" onClick={onClosedClick} className="bg-white p-4 rounded shadow flex items-center gap-3 w-full text-left hover:ring-2 ring-slate-200">
      ...
      <button type="button" onClick={onInSlaClick} className="bg-white p-4 rounded shadow flex items-center justify-between w-full text-left hover:ring-2 ring-slate-200">
        <div>
      ...
      <button type="button" onClick={onOutSlaClick} className="bg-white p-4 rounded shadow flex items-center justify-between w-full text-left hover:ring-2 ring-slate-200">
        <div>
